...
$deleteCommand = filter_input(INPUT_GET,'delcom2');
...
<table id="patient" class="display">
    ...
    <tbody>
        ...
        foreach ($patients as $patient) {
            ...
            echo '<td><button onclick="updatePatient('.$patient['id'].');">Update</button>
                  <button onclick="deletePatient('.$patient['id'].');">Delete</button></td>';
            echo '</tr>';
        }
        ?>
    </tbody>
